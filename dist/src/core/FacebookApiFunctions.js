...
export class FacebookApiFunctions {
    ...
    async sendMessage(message, threadID, callback) {
        try {
            ...
            const response = await HttpClient.post("https://www.facebook.com/messaging/send/", this.ctx.cookieJar, form);
            if (response.statusCode !== 200) {
                throw ErrorHandler.createError(ErrorType.NETWORK, `Send message failed with status ${response.statusCode}`, null, { threadID, statusCode: response.statusCode });
            }
    ...
    async getUserInfo(userIDs, callback) {
        try {
            ...
            const response = await HttpClient.post("https://www.facebook.com/chat/user_info/", this.ctx.cookieJar, form);
            const result = this.parseResponse(response.body);
            if (callback)
                callback(null, result);
            return result;
    ...
    async getThreadInfo(threadIDs, callback) {
        try {
            ...
            const response = await HttpClient.post("https://www.facebook.com/api/graphqlbatch/", this.ctx.cookieJar, form);
            const result = this.parseResponse(response.body);
            if (callback)
                callback(null, result);
            return result;
    ...
    async getFriendsList(callback) {
        try {
            const response = await HttpClient.postFormData("https://www.facebook.com/chat/user_info_all", this.ctx.cookieJar, {}, { viewer: this.ctx.UserID });
            const result = this.parseResponse(response.body);
    ...
    async markAsRead(threadID, callback) {
        try {
            ...
            await HttpClient.post("https://www.facebook.com/ajax/mercury/change_read_status.php", this.ctx.cookieJar, form);
            if (callback)
                callback(null);
        }
        catch (error) {
    ...
    async sendTypingIndicator(threadID, isTyping = true, callback) {
        try {
            ...
            await HttpClient.post("https://www.facebook.com/ajax/messaging/typ.php", this.ctx.cookieJar, form);
            if (callback)
                callback(null);
        }
        catch (error) {
    ...
    parseResponse(body) {
        try {
            ...
            throw ErrorHandler.handleParsingError(error, {
                ...
                bodyPreview: body && typeof body === "string"
...
//# sourceMappingURL=FacebookApiFunctions.js.map